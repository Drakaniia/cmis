...
export function LineLoadingPulseStroke({
  ...
  // §14 Reduced motion — render the full path without the animated clip.
  if (reduceMotion) {
    return (
      <>
        <defs>
